...
class GiaoDichCoPhan(models.Model):
    ...
    state = fields.Selection(
        [('0', 'Nháp'), ('1', 'Đang bán'), ('2', 'Đang giao dịch'), ('3', 'GD thành công'), ('4', 'GD thất bại'),
         ('5', 'Đã hủy')],
    ...
    user_create = fields.Many2one(comodel_name='user.profile', string='Người tạo lệnh',
    ...
    cus_order = fields.Many2one(comodel_name='user.profile', string='Người mua', readonly=True,
                                track_visibility='onchange')
    pur_order = fields.Many2one(comodel_name='user.profile', string='Người bán', readonly=True,
                                track_visibility='onchange')
    ...
    phi_giao_dich = fields.Integer(string='Phí giao dịch (% Tổng bill)', help='Phí giao dịch theo % tổng bill',
                                   compute='get_phigd')
    total_bill = fields.Integer(string='Tổng bill phải trả', compute='get_total_bill')
    type_gd = fields.Selection([('sale', 'Bán'), ('purchase', 'Mua')], string='Kiểu giao dịch', default='sale',
                               required=True)
