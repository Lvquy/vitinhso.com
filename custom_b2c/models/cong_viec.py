...
class CongViec(models.Model):
    ...
    state = fields.Selection([('0', 'Nháp'), ('1', 'Xác nhận'), ('2', 'Đã hoàn thành'), ('3', 'Đã hủy')],
                             string='Trạng thái',
...
class BaoCaoCV(models.Model):
    ...
    date_create = fields.Datetime(string='Ngày báo cáo', default=datetime.today(), readonly=True,
