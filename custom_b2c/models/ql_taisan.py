...
class TaiSan(models.Model):
    ...
    status = fields.Selection([('0', 'New'), ('1', 'Đang sử dụng'), ('2', 'Đã Hủy')], string='Trạng thái tài sản',
                              default='0'
                              , track_visibility='onchange')
    id_taisan = fields.Char(string='ID tài sản', default=lambda self: ('New'), track_visibility='onchange',
                            readonly=True)
    ...
    of_user = fields.Many2one(comodel_name='hr.employee', string='Người đang bảo quản', track_visibility='onchange',
                              readonly=True)
